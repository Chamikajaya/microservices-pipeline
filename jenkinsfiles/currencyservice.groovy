pipeline {
    ...
    environment {
        ...
        REPO_URL = "497237776404.dkr.ecr.ap-south-1.amazonaws.com/devops-microservices-dev-currencyservice"
            ...
            steps {
                script {
                    withCredentials([
                        ...
                        docker tag currencyservice:latest ${REPO_URL}:${BUILD_NUMBER}
