pipeline {
    ...
    environment {
        ...
        REPO_URL = "497237776404.dkr.ecr.ap-south-1.amazonaws.com/devops-microservices-dev-recommendationservice"
            ...
            steps {
                script {
                    withCredentials([
                        ...
                        docker tag recommendationservice:latest ${REPO_URL}:${BUILD_NUMBER}
