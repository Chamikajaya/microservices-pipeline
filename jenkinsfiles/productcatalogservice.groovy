pipeline {
    ...
    environment {
        ...
        REPO_URL = "497237776404.dkr.ecr.ap-south-1.amazonaws.com/devops-microservices-dev-productcatalogservice"
            ...
            steps {
                script {
                    withCredentials([
                        ...
                        docker tag productcatalogservice:latest ${REPO_URL}:${BUILD_NUMBER}
