pipeline {
    ...
    environment {
        ...
        REPO_URL = "497237776404.dkr.ecr.ap-south-1.amazonaws.com/devops-microservices-dev-shippingservice"
            ...
            steps {
                script {
                    withCredentials([
                        ...
                        docker tag shippingservice:latest ${REPO_URL}:${BUILD_NUMBER}
